...
WHERE customers.city=employees.city AND employees.city='London' AND ship_via = 2
...
SELECT product_name
FROM products
WHERE EXISTS(SELECT DISTINCT product_id FROM order_details WHERE order_details.quantity = 10)